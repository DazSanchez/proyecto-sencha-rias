CREATE USER 'db_user'@'localhost' IDENTIFIED WITH mysql_native_password BY 'user_password';
CREATE USER 'db_user'@'%' IDENTIFIED WITH mysql_native_password BY 'user_password';
